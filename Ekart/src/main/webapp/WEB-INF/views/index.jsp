                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="banner">
                                                <a href="#">
                                                    <img src="<c:url value ="/resources/resources/img/banner.jpg"/>" class="img img-responsive" alt="">
                                                </a>
                                            </div>
                                            <div class="banner">
                                                <a href="#">
                                                    <img src="<c:url value ="/resourcesimg/banner2.jpg"/>" class="img img-responsive" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="<c:url value ="/resourcesimg/main-slider1.jpg"/>" alt="" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="<c:url value ="/resourcesimg/main-slider2.jpg"/>" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="<c:url value ="/resourcesimg/main-slider3.jpg"/>" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="<c:url value ="/resourcesimg/main-slider4.jpg"/>" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
