		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand home" href="index"
					...
					src="<c:url value="resources/img/logo.png"/>" alt="Obaju logo"
					class="hidden-xs"> <img
								...
								<div class="yamm-content">
									<div class="row">
										...
										<div class="col-sm-3">
											<div class="banner">
												<a href="#"> <img
													src="<c:url value="resources/img/banner.jpg"/>"
													class="img img-responsive" alt="">
												</a>
											</div>
											<div class="banner">
												<a href="#"> <img
													src="<c:url value="resources/img/banner2.jpg"/>"
													class="img img-responsive" alt="">
												</a>
											</div>
										</div>
					...
					<div class="box">
						...
						<form:form action="register" method="post"
							...
							<div class="form-group">
								...
								<form:input path="user_mobile_number" type="text"
									class="form-control"></form:input>
								<form:errors path="user_mobile_number" cssStyle="color: #ff0000" />
							</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						...
						<p>
							<strong>AJ Pvt Ltd.</strong> <br>232 <br>N.S.Palya <br>BMT
							2 Stage <br>Bengaluru <br> <strong>India</strong>
						</p>
